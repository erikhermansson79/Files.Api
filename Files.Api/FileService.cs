...
namespace Files.Api
{
    public partial class FileService : IFileService
    {
        ...
        public void ChangeItemName(ChangeItemNameModel changeItemNameModel)
        {
            ...
            var newPath = Path.Combine(Path.GetDirectoryName(path)!, changeItemNameModel.Name.ReplaceReservedCharacters());
            ...
            else if (changeItemNameModel.Type == "link")
            {
                ...
                {
                    fileLinkModel.DisplayName = changeItemNameModel.Name.ReplaceReservedCharacters();
        ...
        public void CreateFolder(CreateFolderModel createFolderModel)
        {
            ...
            dir.CreateSubdirectory(createFolderModel.FolderName.ReplaceReservedCharacters());
        }
        ...
        private async Task<ContentModel> GetDirectoryAsync(string? path = null, uint page = 1, int pageSize = 20)
        {
            ...
            var isAdminCheck = _authorizationService != null
        ...
        public async Task UploadFileChunkAsync(UploadFileModel uploadFileModel)
        {
            ...
            var target = Path.Combine(_directories.LibraryDirectory, uploadFileModel.Target.TrimStart('/').Replace('/', '\\').ReplaceReservedCharacters());
